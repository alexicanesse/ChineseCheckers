...
class BoardArea(Canvas):
    ...
    def __init__(self, parent, width, height):
        ...
        #working data to test player moves 
    ...
    def jouerIA(self):
        ...
        # Apply player move
        # test functions
        print("who is to play",self.board.get_who_is_to_play_())
        self.joueurajouer = self.board.move(0,self.coup_courant)
        print("Joueur a jouer",self.joueurajouer,self.coup_courant)
        ...
        if self.joueurajouer:
            ...
            if self.board.move(1,temp[1]): #AI is player 1  #TODO adapt toallow AI to be either player 0 or player 1
                self.appliquer_coup(temp[0],temp[1])
            else:
                print("AI played an illegal move")
